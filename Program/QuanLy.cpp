...
bool QuanLy :: checkCusId(const string& id){
    if (id[0] != 'C' || id[1] != 'U' || id[2] != 'S') {
        cout << setfill(char(' ')) << setw(40) << "" << "Dinh dang cua ma khach hang phai la CUSabc, voi abc la so nguyen duong!\n";
        return 0;
    }
...
bool QuanLy :: checkSupId(const string& id){
    if (id[0] != 'S' || id[1] != 'U' || id[2] != 'P') {
        cout << setfill(char(' ')) << setw(40) << "" << "Dinh dang cua ma nha cung cap phai la SUPabc, voi abc la so nguyen duong!\n";
        return 0;
    }
    for (int i = 3; i < id.size() - 1; i++){
        if (id[i] < '0' || id[i] > '9') {
...
bool QuanLy :: checkInpId(const string& id){
    if (id[0] != 'I' || id[1] != 'N' ) {
        cout << setfill(char(' ')) << setw(40) << "" << "Dinh dang cua ma don nhap phai la INabc, voi abc la so nguyen duong!\n";
        return 0;
    }
...
bool QuanLy :: checkDinId(const string& id){
    if (id[0] != 'D' || id[1] != 'I' || id[2] != 'N') {
        cout << setfill(char(' ')) << setw(40) << ""<< "Dinh dang cua ma chi tiet don nhap phai la DINabc, voi abc la so nguyen duong!\n";
        return 0;
    }
    for (int i = 3; i < id.size() - 1; i++){
        if (id[i] < '0' || id[i] > '9') {
...
bool QuanLy :: checkOutId(const string& id){
    if (id[0] != 'O' || id[1] != 'U' || id[2] != 'T') {
        cout << setfill(char(' ')) << setw(40) << ""<< "Dinh dang cua ma don xuat phai la OUTabc, voi abc la so nguyen duong!\n";
        return 0;
    }
    for (int i = 3; i < id.size() - 1; i++){
        if (id[i] < '0' || id[i] > '9') {
...
bool QuanLy :: checkDoutId(const string& id){
    if (id[0] != 'D' || id[1] != 'O' || id[2] != 'U' || id[3] != 'T') {
        cout << setfill(char(' ')) << setw(40) << ""<< "Dinh dang cua ma chi tiet don xuat phai la DOUTabc, voi abc la so nguyen duong!\n";
        return 0;
    }
...
bool QuanLy :: checkUnitId(const string& id){
    if (id[0] != 'U' || id[1] != 'N' || id[2] != 'I' || id[3] != 'T') {
        cout << setfill(char(' ')) << setw(40) << "" << "Dinh dang cua ma loai hang phai la UNITabc, voi abc la so nguyen duong!\n";
        return 0;
    }
    for (int i = 4; i < id.size() - 1; i++){
        if (id[i] < '0' || id[i] > '9') {
...
bool QuanLy :: checkProId(const string& id){
    if (id[0] != 'P' || id[1] != 'R' || id[2] != 'O') {
        cout << setfill(char(' ')) << setw(40) << "" << "Dinh dang cua ma san pham phai la PROabc, voi abc la so nguyen duong!\n";
        return 0;
    }
    for (int i = 3; i < id.size() - 1; i++){
        if (id[i] < '0' || id[i] > '9') {
...
void QuanLyXuatKho :: menuOut(){
    ...
    string tmp;
    while (true){
        cout << setfill(char(' ')) << setw(40) << "" << "1. Quan ly don xuat\n";
        cout << setw(40) << "" << "2. Quan ly khach hang\n";
        cout << setw(40) << "" << "3. Thoat chuong trinh\n";
        cout << setw(40) << "" << "Nhap lua chon cua ban: ";
        cin >> tmp;
...
void QuanLyXuatKho::manaOutput(){
    ...
    string tmp;
    while (true){
        cout << setfill(char(' ')) << setw(40) << "" << "1. In don xuat\n";
        cout << setw(40) << "" << "2. Nhan don dat hang\n";
        cout << setw(40) << "" << "3. Xem doanh so ban hang\n";
        cout << setw(40) << "" << "4. Quay lai\n";
        cout << setw(40) << "" << "Nhap lua chon cua ban: ";
        cin >> tmp;
        if (checkInt(tmp)) opt = stoi(tmp);
        else opt = 0;
...
void QuanLyXuatKho ::manaCus(){
    ...
    string tmp;
    while (true){
        cout << setfill(char(' ')) << setw(40) << "" <<  "1. In thong tin cac khach hang\n";
        cout << setw(40) << "" <<"2. Them khach hang\n";
        cout << setw(40) << "" <<"3. Sua thong tin khach hang\n";
        cout << setw(40) << "" << "4. Xoa khach hang\n";
 ...
 void QuanLyXuatKho::showFin(){
    cout << setfill(char(' ')) << setw(40) << "" <<  "Nhap nam can xem: ";
    ...
    for (int m = 1; m < 13; m++){
        cout << setfill(char(' ')) << setw(40) << "" << "|" << setfill(char(' '))
 ...
 void QuanLyXuatKho::ShowCustomer()
{
    ...
    cout << "\n";
    cout << setfill(char(' ')) << setw(10) << "" << "| CUS ID |" << setfill(char(' ')) << setw(10) << "" << "Name" << setw(10) << "" << "|"
    << setw(12) << "" << "ADDRESS" << setw(12) << "" << "|" << setw(5) << "" << "PHONE" << setw(5) << "" << "|\n";
    cout << setfill(char(' ')) << setw(10) << "" << setfill(char(205)) << setw(83) <<"";
    cout << "\n";
...
void QuanLyXuatKho :: takeOrder(){
    cout << setfill(char(' ')) << setw(40) << "" << "Nhan don dat hang\n";
    string outId, dayOut;
    int outCheck;
    do {
        outCheck = 0;
        do{
            cout << setw(40) << "" << "Nhap ma don dat hang: ";
            cin >> outId;
        }while (!checkOutId(outId));
        cout << "\n";
        for (auto &i : this->DataOutput){
            if (i.getOutputId() == outId){
                cout << setw(40) << "" << "Ma don dat hang da ton tai!\n";
                outCheck = 1;
                break;
            }
        }
    } while (outCheck);
    cout << setw(40) << "" << "Nhap ngay dat hang: ";
    cin >> dayOut;
    cout << "\n";
    ...
    int cusCheck = 0;
    do{
        cout << setw(40) << "" << "Nhap ma khach hang dat mua hang: ";
        cin >> cusId;
    ...
    //Going...
    if (!cusCheck) {
        cout << setw(40) << "" << "Them thong tin khach hang moi\n";
        string cusName, cusAddr, cusPhone;
        cout << setw(40) << "" << "Nhap ten khach hang: "; cin.ignore(); getline(cin, cusName);
        cout << setw(40) << "" << "Nhap dia chi khach hang: "; getline(cin, cusAddr);
        cout << setw(40) << "" << "Nhap SDT khach hang: "; cin >> cusPhone;
    ...
    while (true){
        do{
            doutCheck = 0;
            do{
                cout << setw(40) << "" << "Nhap ma chi tiet don dat hang: ";
                cin >> doutId;
            } while(!checkDoutId(doutId));
            cout << "\n";
            for (auto &i : this->DataDetailOutput){
                if (i.getDetailOutputId() == doutId){
                    cout << setw(40) << "" << "Ma chi tiet don dat hang da ton tai!\n";
                    doutCheck = 1;
                    break;
                }
            }
        ...
        while (true){
            ...
            if (!proCheck) cout << setw(40) << "" << "San pham khong ton tai! Chon san pham khac\n";
            else break;
        }
        string tmp = "a";
        while (!checkInt(tmp)){
            cout << setw(40) << "" << "Nhap so luong muon mua (La so nguyen duong): ";
            cin >> tmp;
        }
        count = stoi(tmp);
        int tmpcount = count;
        int rest = 0;
        for (auto &i : this->DataDetailInput){
            if (i.getProductId() == proId) rest += i.getRest();
        }
        cout << setw(40) << "" << "So luong con lai cua san pham la: " << rest << "\n";
        if (rest < count) {
            cout << setw(40) << "" << "So luong ton kho khong du!\n";
            int opt;
            string tmp;
            while (true){
                cout << setw(40) << "" << "1. Chon san pham khac hoac thay doi thong tin chi tiet don dat hang\n";
                cout << setw(40) << "" << "2. Hoan thanh dat hang\n";
                cout << setw(40) << "" << "Nhap lua chon cua ban: ";
                cin >> tmp;
                if (checkInt(tmp)) opt = stoi(tmp);
                else opt = 0;
                if (opt == 1 || opt == 2 ) break;
                else cout << setw(40) << "" << "Lua chon sai, vui long chon lai\n";
            }
            if (opt == 1) continue;
            else {
                cout << setw(40) << "" << "Hoan thanh don dat hang!\n";
                manaOutput();
            }
        }
        ...
        int opt;
        while(true){
            cout << setw(40) << "" << "1. Them san pham\n";
            cout << setw(40) << "" << "2. Hoan thanh don dat hang\n";
            cout << setw(40) << "" << "Nhap lua chon cua ban: ";
            cin >> tmp;
            if (checkInt(tmp)) opt = stoi(tmp);
            else opt = 0;
            if (opt != 1 && opt != 2) cout << "Nhap sai lua chon, vui long nhap lai!\n";
            else break;
        }
        if (opt == 2) {
            cout << setw(40) << "" << "Hoan thanh dat hang\n"; 
            break;
        }
    }
    system("pause");
...
void QuanLyXuatKho::InsertCustomer()
{
    ...
    while(true)
    {
        ...
        for(auto &i : this->DataCustomer)
        {
            if(i.getId() == s1)
            {
                cout << setw(40) << "" << "ID Vua Nhap Da Ton Tai, Xin Moi Nhap Lai!\n";
                check = true;
                break;
    ...
    cout << setw(40) << "" << "Nhap Ten Khach Hang:";
    cin.ignore();
    getline(cin,s2);
    cout << setw(40) << "" << "Nhap Dia Chi Khach Hang:";

    getline(cin,s3);
    cout << setw(40) << "" << "Nhap So Dien Thoai Khach Hang:";

    cin >> s4;
    DataCustomer.push_back(Customer(s1,s2,s3,s4));
    cout << setw(40) << "" << "Khach Hang Da Duoc Them Thanh Cong!\n";
...
void QuanLyXuatKho::DeleteCustomer()
{
    ...
    do{
        cout << setw(40) << "" << "Nhap ID Khach Hang Can Xoa: ";
        cin >> s;
    } while(!checkCusId(s));
    bool check = false;
    ...
    if(check == false) cout << setw(40) << "" << "Khong Tim Thay Khach Hang Can Xoa!\n";
    else cout << setw(40) << "" << "Da Xoa Thanh Cong!\n";
}
void QuanLyXuatKho::SetCustomer()
{
    ...
    {   
        string s1;
        do{
            cout << setw(40) << "" << "Nhap ID Khach Hang Can Update:";
            cin >> s1;
        } while (!checkCusId(s1));
        bool check = false;
        for(int i = 0; i <= this->DataCustomer.size() - 1; i++)
        ...
        if(check == false)
        {
            cout << setw(40) << "" << "Khong Tim Thay Khach Hang Can Update,Xin Moi Nhap Lai!\n";
        }
        else
        {
            cout << setw(40) << "" << "Da Tim Thay Khach Hang Can Update!\n";
            break;
        }
    }
    cout << setw(40) << "" << "0:Dung Update\n";
    cout << setw(40) << "" << "1:Update Name\n";
    cout << setw(40) << "" << "2:Update Address\n";
    cout << setw(40) << "" << "3:Update PhoneNumber\n";
    while(true)
    {
        int opt;
        string tmp;
        cout << setw(40) << "" << "Nhap Thuoc Tinh Can Update:";
        cin >> tmp;
        if (checkInt(tmp)) opt = stoi(tmp);
        else opt = -1;
        if(opt == 0)
        {
            cout << setw(40) << "" << "Da Update Xong!\n";
            break;
        }
        if(opt == 1)
        {
            string s1;
            cout << setw(40) << "" << "Nhap Ten Muon Update:";
            cin.ignore();
            getline(cin,s1);
        ...
        {
            string s2;
            cout << setw(40) << "" << "Nhap Dia Chi Muon Update:";
            cin.ignore();
            getline(cin,s2);
        ...
        {
            string s3;
            cout << setw(40) << "" << "Nhap So Dien Thoai Muon Update:";
            cin >> s3;
            DataCustomer[pos].setPhoneNumber(s3);
        }
        if (opt == -1) cout << setw(40) << "" << "Nhap sai lua chon, moi nhap lai!\n";
    }
}
void QuanLyXuatKho::ShowOutput()
{
    ...
    cout << "\n";
    cout << setfill(char(' ')) << setw(40) << "" << "| OUT ID |" << setfill(char(' ')) << setw(5) << "" << "DATE" << setw(6) << "|" << "\n";
    cout << setfill(char(' ')) << setw(40) << "" << setfill(char(205)) << setw(25) <<"";
    cout << "\n";
...
void QuanLyXuatKho::ShowDetailOutput()
{
    ...
    {
        do{
            cout << setfill(char(' ')) <<  setw(30) << ""  << "Nhap Ma Don Xuat De Xem Don Xuat Chi Tiet: ";
            cin >> s;
        } while (!checkOutId(s));
        bool check = false;
        for(auto &i : this->DataOutput)
        {
            if(i.getOutputId() == s)
            {
                    ...
                    cout << "\n";
                    cout << setfill(char(' ')) << setw(30) << "" << "| DOUT ID |" << setfill(char(' ')) << setw(2) << "" 
                    << "OUT ID" << setw(2) << "" << "|" << setw(2) << "" 
                    << "PRO ID" << setw(2) << "" << "|" << setw(2) << "" 
                    << "DIN ID" << setw(2) << "" << "|" << setw(2) << ""
                    << "CUS ID" << setw(2) << "" << "|" << setw(2) << ""
                    << "COUNT  " << setw(6) << "|";
                    cout << "\n";
                    cout << setfill(char(' ')) << setw(30) << "" << setfill(char(205)) << setw(65) <<"";
                    cout << "\n";
                ...
                {
                    if (x.getOutputId() == s){
                            cout << setfill(char(' ')) << setw(30) << "" << "|" << setfill(char(' '))
        ...
        if(check == false)
        {
            cout << setw(40) << "" << "Khong Tim Thay Ma Don Xuat,Xin Moi Nhap Lai!\n";
        }
        else break;
...
void QuanLyNhapKho::menuIn(){
    ...
    string tmp;
    while (opt != 3){
        cout << setfill(char(' ')) << setw(40) << "" << "1. Quan ly don nhap\n";
        cout << setw(40) << "" << "2. Quan ly nha cung cap\n";
        cout << setw(40) << "" << "3. Thoat chuong trinh\n";
        cout << setw(40) << "" << "Nhap lua chon cua ban: ";
        cin >> tmp;
        if (checkInt(tmp)) opt = stoi(tmp);
...
void QuanLyNhapKho :: manaInput(){
    ...
    string tmp;
    while (opt != 4){
        cout << setfill(char(' ')) << setw(40) << "" << "1. In hoa don nhap hang\n";
        cout << setw(40) << "" << "2. Nhan don hang\n";
        cout << setw(40) << "" << "3. Xem thong ke tien nhap hang\n";
        cout << setw(40) << "" << "4. Quay lai\n";
        cout << setw(40) << "" << "Nhap lua chon cua ban: ";
        cin >> tmp;
        if (checkInt(tmp)) opt = stoi(tmp);
...
bool cmp3(DetailInput a, DetailInput b)
{
    ...
    for(auto i : v4)
    {
     ...
     if(x.getYearInput(x.getDayOfInput()) > y.getYearInput(y.getDayOfInput())) return true;
    else if (x.getYearInput(x.getDayOfInput()) == y.getYearInput(y.getDayOfInput()))
    {
        if(x.getMonthInput(x.getDayOfInput()) > y.getMonthInput(y.getDayOfInput())) return true;
        else if(x.getMonthInput(x.getDayOfInput()) == y.getMonthInput(y.getDayOfInput()))
        {
            if(x.getDayInput(x.getDayOfInput()) > y.getDayInput(y.getDayOfInput())) return true;
            else return false;
        }
        return false;
    }
...
void QuanLyNhapKho :: manaSup(){
    ...
    string tmp;
    while (opt != 5){
        cout << setfill(char(' ')) << setw(40) << "" << "1. In thong tin cac nha cung cap\n";
        cout << setw(40) << "" << "2. Them nha cung cap\n";
        cout << setw(40) << "" << "3. Sua thong tin nha cung cap\n";
        cout << setw(40) << "" << "4. Xoa nha cung cap\n";
        cout << setw(40) << "" << "5. Quay lai\n";
        cout << setw(40) << "" << "Nhap lua chon cua ban: ";
        cin >> tmp;
        if (checkInt(tmp)) opt = stoi(tmp);
 ...
 void QuanLyNhapKho :: showFin(){
    string year;
    cout << setw(40) << "" << "Nhap nam can kiem tra: ";
    cin >> year;
    for (int m = 1; m < 13; m++){
        int money = 0;
        for (auto i : this->DataInput){
        ...
        cout << setw(40) << "" << "Tien nhap hang thang " << m << ": " << money << endl;
    }
 }
...
{   
    ...
    cout << "\n";
    cout << setfill(char(' ')) << setw(20) << "" << "| SUP ID |" << setfill(char(' ')) << setw(10) << "" << "NAME" << setw(10) << "" << "|"
    << setw(12) << "" << "ADDRESS" << setw(12) << "" << "|" << setw(5) << "" << "PHONE" << setw(5) << "" << "|\n";
    cout << setfill(char(' ')) << setw(20) << "" << setfill(char(205)) << setw(83) <<"";
    cout << "\n";

    for (auto i : this->DataSupplier){
        cout << setfill(char(' ')) << setw(20) << "" << "|" << setfill(char(' '))
...
void QuanLyNhapKho::InsertSupplier()
{
    ...
    cout << setw(40) << "" << "Nhap Ten Nha Cung Cap:";
    cin.ignore();
    getline(cin,s2);
    cout << setw(40) << "" << "Nhap Dia Chi Nha Cung Cap:";

    getline(cin,s3);
    cout << setw(40) << "" << "Nhap So Dien Thoai Nha Cung Cap:";

    cin >> s4;
    DataSupplier.push_back(Supplier(s1,s2,s3,s4));
    cout << setw(40) << "" << "Nha Cung Cap Da Duoc Them Thanh Cong!\n";
}
...
void QuanLyNhapKho::DeleteSupplier()
{
    string s;
    do{
        cout << setw(40) << "" << "Nhap ID Nha Cung Cap Can Xoa:\n";
        cin >> s;
    } while (!checkSupId(s));
    bool check = false;
    ...
    if(check == false) cout << setw(40) << "" << "Khong Tim Thay Nha Cung Cap Can Xoa!\n";
    else cout << setw(40) << "" << "Da Xoa Thanh Cong!\n";
}
...
void QuanLyNhapKho::SetSupplier()
{
    ...
    {   
        string s1;
        do{
            cout << setw(40) << "" << "Nhap ID Nha Cung Cap Can Update:";
            cin >> s1;
        } while(!checkSupId(s));
        bool check = false;
        for(int i = 0; i <= this->DataSupplier.size() - 1; i++)
        ...
        if(check == false)
        {
            cout << setw(40) << "" << "Khong Tim Thay Nha Cung Cap Can Update,Xin Moi Nhap Lai!\n";
        }
        else
        {
            cout << setw(40) << "" << "Da Tim Thay Nha Cung Cap Can Update!\n";
            break;
        }
    }
    cout << setw(40) << "" << "0:Dung Update\n";
    ...
    while(true)
    {
        ...
        string tmp;
        cout << "\n";
        cout << setfill(char(' ')) << setw(40) << "" << "Nhap Thuoc Tinh Can Update:";
        cin >> tmp;
        if (checkInt(tmp)) opt = stoi(tmp);
        else opt = -1;
        if(opt == 0)
        ...
        if (opt == -1) cout << setw(40) << "" << "Nhap sai lua chon, moi ban nhap lai!\n";
    }
...
void QuanLyNhapKho :: getOrder(){
    ...
    do{
        check = 0;
        do{
            cout << setfill(char(' ')) << setw(40) << "" << "Nhap ma don nhap: ";
            cin >> inputId;
        } while (!checkInpId(inputId));
        cout << "\n";
        for (auto &i : this->DataInput){
            if (i.getInputId() == inputId) {
                cout << setw(40) << "" << "Ma don nhap da ton tai, vui long nhap lai!\n";
                check = 1;
            }
        }
    }while(check);

    cout << setw(40) << " " << "Nhap ngay nhap hang: \n";
    cin >> dateInput;
    ...
    while (true){
    cout << setw(40) << "" << "Nhap chi tiet don hang \n";
    string dinId, proId;
    ...
    while (true){
        check = 0;
        do{
            cout << setw(40) << "" << "Nhap ma chi tiet don nhap: ";
            cin >> dinId;
        } while (!checkDinId(dinId));
        for (auto &i : this->DataDetailInput){
            if (i.getDetailInputId() == dinId){
                cout << setw(40) << "" << "Ma chi tiet don nhap da ton tai, vui long nhap lai!\n";
                check = 1;
                break;
            }
        }
    ...
    if (!check){
        ...
        if (!proCheck){
            ...
            cout << setw(40) << "" << "Them san pham moi\n";
            string supId, proName, unitId;
            cout << setw(40) << "" << "Nhap ten san pham moi: ";
            cin.ignore();
            getline(cin, proName);
            do{
                cout << setw(40) << "" << "Nhap ma nha cung cap: ";
                cin >> supId;
            ...
            if (!supCheck){
                cout << setw(40) << "" << "Nha cung cap nay chua ton tai, vui long them\n";
            ...
            do{
                cout << setw(40) << "" << "Nhap ma loai hang: ";
                cin >> unitId;
            ...
            if (!unitCheck){
                cout << setw(40) << "" << "Loai hang nay chua ton tai, vui long them\n";
                string unitName;
                cout << setw(40) << "" << "Nhap ten loai hang: ";
                cin.ignore();
        ...
        while (true){
            cout << "\n";
            cout << setw(40) << "" << "Nhap so luong nhap(La so nguyen duong): ";
            cin >> tmp;
            if (checkInt(tmp)) {
                countIn = stoi(tmp);
                break;
        ...
        while (true){
            cout << "\n";
            cout << setw(40) << "" << "Nhap gia nhap vao(La so nguyen duong): ";
            cin >> tmp;
            if (checkInt(tmp)) {
                priceIn = stoi(tmp);
                break;
        ...
        while (true){
            cout << "\n";
            cout << setw(40) << "" << "Nhap gia ban ra(La so nguyen duong): ";
            cin >> tmp;
            if (checkInt(tmp)) {
                priceOut = stoi(tmp);
                break;
    ...
    while(true){
        cout << setw(40) << "" << "1. Them san pham\n";
        cout << setw(40) << "" << "2. Hoan thanh nhan don hang\n";
        cout << setw(40) << "" << "Nhap lua chon cua ban: ";
        cin >> tmp;
        if (checkInt(tmp)) opt = stoi(tmp);
        else opt = 0;
        if (opt != 1 && opt != 2) cout << setw(40) << "" << "Nhap sai lua chon, vui long nhap lai!\n";
        else break;
    }
    if (opt == 2) {
        SortDetailInput();
        cout << setw(40) << "" << "Nhan don hang thanh cong\n"; 
        break;
    }
    }
    system("pause");
...
void QuanLyNhapKho::ShowInput()
{
    ...
    cout << setfill(char(' ')) << setw(40) << "" << setfill(char(205)) << setw(25) <<"";
    cout << "\n";
    cout << setfill(char(' ')) << setw(40) << "" << "| INP ID |" << setfill(char(' ')) << setw(5) << "" << "DATE" << setw(6) << "|" << "\n";
    cout << setfill(char(' ')) << setw(40) << "" << setfill(char(205)) << setw(25) <<"";
    cout << "\n";
...
void QuanLyNhapKho::ShowDetailInput()
{
    ...
    {
        do{
            cout << setfill(char(' ')) << setw(40) << "" << "Nhap Ma Don Nhap De Xem Don Nhap Chi Tiet:";
            cin >> s;
        } while (!checkInpId(s));
        bool check = false;
        for(auto &i : this->DataInput)
        {
            if(i.getInputId() == s)
            {
                    ...
                    cout << "\n";
                    cout << setfill(char(' ')) << setw(25) << "" << "| DIN ID |" << setfill(char(' ')) << setw(2) << "" 
                    << "INP ID" << setw(2) << "" << "|" << setw(2) << "" 
                    << "PRO ID" << setw(2) << "" << "|" << setw(2) << "" 
                    << "COUNT" << setw(2) << "" << "|" << setw(2) << ""
                    << "PRICE IN" << setw(2) << "" << "|" << setw(2) << ""
                    << "PRICE OUT" << setw(2) << "" << "|" << setw(2) << ""
                    << "REST  " << setw(6) << "|";
                    cout << "\n";
                    cout << setfill(char(' ')) << setw(25) << "" << setfill(char(205)) << setw(78) <<"";
                    cout << "\n";
                ...
                {
                    if (x.getInputId() == s){
                            cout << setfill(char(' ')) << setw(25) << "" << "|" << setfill(char(' '))
        ...
        if(check == false)
        {
            cout << setw(40) << "" << "Khong Tim Thay Ma Don Nhap,Xin Moi Nhap Lai!\n";
        }
        else break;
...
void QuanLyTongKho::menuAll(){
    ...
    string tmp;
    while (true){
        cout << setw(40) << "" << "1. Quan ly hang hoa\n";
        cout << setw(40) << "" << "2. Quan ly doanh thu\n";
        cout << setw(40) << "" << "3. Thoat chuong trinh\n";
        cout << setw(40) << "" << "Nhap lua chon cua ban: ";
        cin >> tmp;
        if (checkInt(tmp)) opt = stoi(tmp);
...
void QuanLyTongKho :: manaPro(){
    ...
    string tmp;
    while (true){
        cout << setfill(char(' ')) << setw(40) << "" << "1. In thong tin hang hoa trong kho\n";
        cout << setw(40) << "" << "2. Sua thong tin 1 mat hang\n";
        cout << setw(40) << "" << "3. Xoa 1 mat hang\n";
        cout << setw(40) << "" << "4. In thong tin cac loai trong kho\n";
        cout << setw(40) << "" << "5. Sua thong tin 1 loai hang\n";
        cout << setw(40) << "" << "6. Xoa 1 loai hang\n";
        cout << setw(40) << "" << "7. Quay lai\n";
        cout << setw(40) << "" << "Nhap lua chon cua ban: ";
        cin >> tmp;
        if (checkInt(tmp)) opt = stoi(tmp);
        else opt = 0;
...
void QuanLyTongKho :: manaFin(){
    ...
    string tmp;
    while (true){
        cout << setfill(char(' ')) << setw(40) << "" << "1. Doanh thu theo nam\n";
        cout << setw(40) << "" << "2. Quay lai\n";
        cout << setw(40) << "" << "Nhap lua chon: ";
        cin >> tmp;
        if (checkInt(tmp)) opt = stoi(tmp);
        else opt = 0;
        switch(opt){
...
{   
    ...
    cout << "\n";
    cout << setfill(char(' ')) << setw(40) << "" << "| UNIT ID |" << setfill(char(' '))<< setw(5) << "" 
    << "UNIT NAME" << setw(6) << "|";
    cout << "\n";
    cout << setfill(char(' ')) << setw(40) << "" << setfill(char(205)) << setw(31) <<"";
    cout << "\n";
...
void QuanLyTongKho::DeleteCategory()
{
    ...
    do{
        cout << setfill(char(' ')) << setw(40) << "" << "Nhap Ma Loai Hang Can Xoa: ";
        cin >> s;
    } while (!checkUnitId(s));
    bool check = false;
    ...
    if(check == false) cout << setw(40) << "" << "Khong Tim Thay Loai Hang Can Xoa!\n";
    else cout << setw(40) << "" << "Da Xoa Thanh Cong!\n";
}
...
void QuanLyTongKho::SetCategory()
{
    ...
    {   
        string s1;
        do{
            cout << setfill(char(' ')) << setw(40) << "" << "Nhap ID Loai Hang Can Update: ";
            cin >> s1;
        } while (!checkUnitId(s1));
        bool check = false;
        for(int i = 0; i <= this->DataCategory.size() - 1; i++)
        ...
        if(check == false)
        {
            cout << setfill(char(' ')) << setw(40) << "" << "Khong Tim Thay Ma Loai Hang Can Update. Xin Moi Nhap Lai!\n";
        }
        else
        {
            cout << setw(40) << "" << "Da Tim Thay Loai Hang Can Update!\n";
            break;
        }
    }
    cout << setw(40) << "" << "0:Dung Update\n";
    cout << setw(40) << "" << "1:Update Ten Loai Hang\n";
    ...
    while(true)
    {
        ...
        {
            string s1;
            cout << setw(40) << "" << "Nhap Ten Loai Hang Muon Update: ";
            cin.ignore();
            getline(cin,s1);
            DataCategory[pos].setproductName(s1);
        }
        if (opt == -1){
            cout << setw(40) << "" << "Nhap sai lua chon, moi nhap lai!\n";
        }
    }
}
...
{   
    ...
    cout << "\n";
    cout << setfill(char(' ')) << setw(25) << "" << "| PRO ID |" << setfill(char(' ')) << setw(2) << "" 
    << "SUP ID" << setw(2) << "" << "|" << setw(10) << "" 
    << "NAME" << setw(10) << "" << "|" << setw(2) << "" 
    << "UNIT ID" << setw(2) << "|";
    cout << "\n";
    cout << setfill(char(' ')) << setw(25) << "" << setfill(char(205)) << setw(57) <<"";
...
void QuanLyTongKho::InsertProduct()
{
    ...
    cout << setw(40) << "" << "Nhap Ten San Pham:";
    cin.ignore();
    getline(cin,s3);
    ...
    cout << setw(40) << "" << "San Pham Da Duoc Them Thanh Cong!\n";
}
...
void QuanLyTongKho::DeleteProduct()
{
    string s;
    do{
        cout << setfill(char(' ')) << setw(40) << "" << "Nhap Ma San Pham Can Xoa: ";
        cin >> s;
    } while (!checkProId(s));
    bool check = false;
    ...
    if(check == false) cout << setw(40) << "" << "Khong Tim Thay San Pham Can Xoa!\n";
    else cout << setw(40) << "" << "Da Xoa San Pham Thanh Cong!\n\n";
}
...
void QuanLyTongKho::SetProduct()
{
    ...
    {   
        string s1;
        do{
            cout << setfill(char(' ')) << setw(40) << "" << "Nhap ID San Pham Can Update: ";
            cin >> s1;
        } while (!checkProId(s1));
        bool check = false;
        for(int i = 0; i <= this->DataProduct.size() - 1; i++)
        ...
        if(check == false)
        {
            cout << setw(40) << "" << "Khong Tim Thay San Pham Can Update,Xin Moi Nhap Lai!\n";
        }
        else
        {
            cout << setw(40) << "" << "Da Tim Thay San Pham Can Update!\n\n";
            break;
        }
    }
    cout << setw(40) << "" << "0:Dung Update\n";
    cout << setw(40) << "" << "1:Update Ma Nha Cung Cap\n";
    cout << setw(40) << "" << "2:Update Ten San Pham\n";
    cout << setw(40) << "" << "3:Update Ma Loai Hang\n";
    while(true)
    {
        int opt;
        string tmp;
        ...
        {
            string s1;
            cout << setw(40) << "" << "Nhap Ma Nha Cung Cap Muon Update:";
            cin >> s1;
        ...
        {
            string s2;
            cout << setw(40) << "" << "Nhap Ten San Pham Muon Update:";
            cin.ignore();
            getline(cin,s2);
        ...
        {
            string s3;
            cout << setw(40) << "" << "Nhap Ma Loai Hang Muon Update:";
            cin.ignore();
            getline(cin,s3);
...
{   
    string month; 
    while (true){
        cout << setfill(char(' ')) << setw(40) << "" << "Nhap thang can xem (01 -> 12): ";
        cin >> month;
        if (stoi(month) > 0 && stoi(month) < 13) break;
    }
    system("cls");
    cout << "\n";
    cout << setfill(char(' ')) << setw(20) << "" << setfill(char(205)) << setw(81) <<"";
    cout << "\n";
    cout << setfill(char(' ')) << setw(20) << "" << "| DIN ID |" << setfill(char(' ')) << setw(2) << "" 
        << "INP ID" << setw(2) << "" << "|" << setw(2) << "" 
        << "PRO ID" << setw(2) << "" << "|" << setw(4) << "" 
        << "DAY" << setw(4) << "" << "|" << setw(2) << ""
        << "COUNT" << setw(2) << "" << "|" << setw(2) << ""
        << "PRICE IN" << setw(2) << "" << "|" << setw(2) << ""
        << "PRICE OUT" << setw(2) << "" << "|" ;
    ...
    cout << "\n";
    cout << setfill(char(' ')) << setw(20) << "" << "| DOUT ID |" << setfill(char(' ')) << setw(2) << "" 
        << "OUT ID" << setw(2) << "" << "|" << setw(4) << "" 
        << "DAY" << setw(4) << "" << "|" << setw(2) << ""
        << "PRO ID" << setw(2) << "" << "|" << setw(2) << "" 
        << "DIN ID" << setw(2) << "" << "|" << setw(2) << ""
        << "CUS ID" << setw(2) << "" << "|" << setw(2) << ""
...
void QuanLyTongKho::ShowCost_Yearly()
{
        ...
        while (true){
            cout << endl;
            cout << setw(40) << "" << "Nhap Nam Can Tinh Doanh Thu: ";
            cin >> s;
            int check = 0;
            for (auto x : DataInput) {
                if (s == x.getYearInput(x.getDayOfInput())) check = 1;
            }
            for (auto x : DataOutput) {
                if (s == x.getYearOutput(x.getDayOfOutput())) check = 1;
            }
            if (check) break;
            else cout << setw(40) << "" << "Du lieu cho nam nay khong ton tai, vui long nhap lai!";
        }
        for(int i = 0; i <= this->DataInput.size() - 1; i++)
        {
    ...
    cout << setfill(char(' ')) << setw(20) << "" << setfill(char(205)) << setw(77) <<"";
    cout << "\n";
    cout << setfill(char(' ')) << setw(20) << "" << "|   Thang   |" << setfill(char(' ')) 
         << setw(6) << "" << "Chi phi" << setw(6) << "" << "|"
         << setw(6) << "" << "Doanh thu" << setw(6) << "" << "|" 
         << setw(6) << "" << "Loi nhuan" << setw(6) << "" << "|\n";
    cout << setfill(char(' ')) << setw(20) << "" << setfill(char(205)) << setw(77) <<"";
    cout << "\n";
        for(int i = 1; i <= 12; i++)
        {   
